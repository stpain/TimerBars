...
TimerBarsDropDownTemplateMixin = {}

function TimerBarsDropDownTemplateMixin:OnLoad()
    self.isOpen = false;
...
function TimerBarsDropDownTemplateMixin:SetWidth(width)
    --self.flyout:SetWidth(width)
end

function TimerBarsDropDownTemplateMixin:SetText(text)
...
TimerBarsDropDownListviewItemTemplateMixin = {}

function TimerBarsDropDownListviewItemTemplateMixin:OnLoad()
    self.dropdown = self:GetParent():GetParent():GetParent():GetParent():GetParent()
end

function TimerBarsDropDownListviewItemTemplateMixin:SetDataBinding(binding, height)
...
function TimerBarsDropDownListviewItemTemplateMixin:ResetDataBinding()
